...
class Trainer(object):
    ...
    def train_by_epoch(self, nb_epochs, save_checkpoint=None, classification = False):
        ...
        iteration = 0
        train_writer = tf.summary.FileWriter('./resnet/train' + self.train_name, self.sess.graph)
        validation_writer = tf.summary.FileWriter('./resnet/validation' + self.train_name)
        test_writer = tf.summary.FileWriter('./resnet/test' + self.train_name)
