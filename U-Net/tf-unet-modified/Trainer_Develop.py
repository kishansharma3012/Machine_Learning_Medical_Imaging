...
class Trainer(object):
    ...
    def train(self, data_provider, output_path, training_iters=10, epochs=100, dropout=0.50, display_step = 1, restore=False, write_graph=False, prediction_path = 'prediction'):
        """
            ...
            for epoch in range(epochs):
                ...
                for step in range((epoch*training_iters), ((epoch+1)*training_iters)):
                    ...
                    if step % display_step == 0:
                        ...
                        val_batch_x, val_batch_classi_y, val_batch_locali_y = data_provider.get_validation_batch(2)
